...
const UploadView: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="mb-4">
        <h1 className="text-lg font-semibold text-secondary-900">Upload Documents</h1>
      ...
      <div className="bg-white rounded-lg shadow p-4">
        ...
        <div className="mt-6">
          <h2 className="text-sm font-medium text-secondary-900">Supported File Types</h2>
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              <div key={item.type} className="bg-secondary-50 p-3 rounded-md">
                <div className="flex items-center">
                  <span className="text-xl mr-3">{item.icon}</span>
                  <div>
                    <h3 className="text-sm font-medium text-secondary-900">{item.type}</h3>
        ...
        <div className="mt-6 bg-primary-50 p-3 rounded-md border border-primary-200">
          <h3 className="text-sm font-medium text-primary-800">Pro Tips</h3>
          <ul className="mt-2 text-xs text-primary-700 space-y-1">
            ...
            <li className="flex items-start">
              ...
              You can upload multiple files at once — drag and drop them together
            </li>
          </ul>
        </div>
      </div>
